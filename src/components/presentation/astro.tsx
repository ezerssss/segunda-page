                ...
                >
                    <CardBody className="md:py-20 md:px-14 md:w-7/12">
                        ...
                        <Typography variant="lead" color="white">
                            Astro is an all-in-one web framework for building
                            fast, content-focused websites. The framework is
                            based in Astro Islands architecture, which
                            represents a leading paradigm shift for frontend web
                            architecture.
                        </Typography>
