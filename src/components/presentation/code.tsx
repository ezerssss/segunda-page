            ...
            <div className="h-full w-screen place-items-center bg-white px-8 py-8">
                <div className="container mx-auto grid items-center relative lg:grid-cols-2">
                    <div className="text-center lg:text-left">
                        ...
                        >
                            Don't write from scratch. Coded examples are
                            included.
                        </Typography>
                        <Typography color="blue-gray" className="lg:pr-20">
                            Using our ecommerce starter template will save a lot
                            of coding time , as it provides a solid foundation
                            for the Online Store, allowing your team to focus on
                            customizing and adding specific features to meet the
                        ...
                        <a href="https://www.creative-tim.com/learning-lab/astro/overview/astro-launch-ui">
                            <Button
                                ...
                                variant="text"
                                size="sm"
                                className="flex items-center mx-auto md:mr-auto lg:ml-0 gap-2 mt-4"
                            >
                                Documentation{" "}
                                <ArrowRightIcon
                                    strokeWidth={2}
